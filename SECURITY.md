...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-wear-swift/security/advisories/new).
...
This policy covers the `SynheartWear` Swift package published from this
